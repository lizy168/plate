...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Add `createPliteLayout(editor, options)` with atomic `runtime.reconfigure`, React
