...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Move emoji insertion to `editor.plugin(EmojiPlugin).update.insert`, isolate
