...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Move find-and-replace decoration into `FindReplacePlugin`, remove its React
