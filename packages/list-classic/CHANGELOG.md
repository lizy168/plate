...
- [#5036](https://github.com/udecode/plate/pull/5036) by [@zbeyens](https://github.com/zbeyens) – Move classic-list behavior to Plite transactions and scoped plugin updates.
